...
function CertificateCard({ certificate }) {
  ...
  return (
    <div className="relative group overflow-hidden border border-[#1d293a] rounded-lg bg-[#1b203e]">
      <img
        src="https://drive.google.com/thumbnail?id=1xiJaG4oj60SiHgOEISj1QL-3mh__BGtU&sz=w10000"
        alt="Certificate"
        className="h-44 w-full transition-transform duration-300 transform group-hover:scale-110"
      />
      ...
      <div className="p-3 text-center">
        ...
        <p className="text-lg font-semibold text-[#16f2b3] hidden group-hover:block transition duration-300">
          {name}
        </p>
      </div>
    </div>
